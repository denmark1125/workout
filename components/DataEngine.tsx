...
import { Zap, Activity, Shield, Award, TrendingUp, Clock, Terminal, Flame, X } from 'lucide-react';
...
const DataEngine: React.FC<DataEngineProps> = ({ profile, metrics, onAddMetric, isDbConnected }) => {
  ...
  const statCards = [
    ...
    { label: 'FFMI 指數', value: calculated.ffmi.toFixed(1), icon: <Shield size={16} />, status: ffmiStatus },
      ...
      <div className="flex flex-col xl:flex-row gap-12">
        <div className="flex-1 space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
             <div className="bg-[#fcfcfc] border border-gray-100 p-6 h-[350px] flex flex-col scanline">
